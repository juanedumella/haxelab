...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/data/level00.oel", AssetType.TEXT);
		path.set ("assets/data/tranzanfuk.oep", "assets/data/tranzanfuk.oep");
		type.set ("assets/data/tranzanfuk.oep", AssetType.TEXT);
		...
		type.set ("assets/images/louse.png", AssetType.IMAGE);
		path.set ("assets/images/manito.png", "assets/images/manito.png");
		type.set ("assets/images/manito.png", AssetType.IMAGE);
		...
		id = "assets/data/level00.oel";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/tranzanfuk.oep";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/images/louse.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/manito.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
